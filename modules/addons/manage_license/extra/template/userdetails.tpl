...
{*<tr>*}
{*<td>numdueinvoices :</td>*}
{*<td>{$user->stats->numdueinvoices}</td>*}
{*</tr>*}
{*<tr>*}
{*<td>dueinvoicesbalance :</td>*}
{*<td>{$user->stats->dueinvoicesbalance}</td>*}
{*</tr>*}
{*<tr>*}
{*<td>income :</td>*}
{*<td>{$user->stats->income}</td>*}
{*</tr>*}
{*<tr>*}
{*<td>creditbalance :</td>*}
{*<td>{$user->stats->creditbalance}</td>*}
{*</tr>*}
{*<tr>*}
{*<td> numoverdueinvoices :</td>*}
{*<td> {$user->stats->numoverdueinvoices} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> creditbalance :</td>*}
{*<td> {$user->stats->creditbalance} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> overdueinvoicesbalance :</td>*}
{*<td> {$user->stats->overdueinvoicesbalance} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> numunpaidinvoices :</td>*}
{*<td> {$user->stats->numunpaidinvoices} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> unpaidinvoicesamount :</td>*}
{*<td> {$user->stats->unpaidinvoicesamount} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> numcancelledinvoices :</td>*}
{*<td> {$user->stats->numcancelledinvoices} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> cancelledinvoicesamount :</td>*}
{*<td> {$user->stats->cancelledinvoicesamount} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> numrefundedinvoices :</td>*}
{*<td> {$user->stats->numrefundedinvoices} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> refundedinvoicesamount :</td>*}
{*<td> {$user->stats->creditbalance} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> refundedinvoicesamount :</td>*}
...
{*</tr>*}
{*<tr>*}
{*<td> productsnumactiveother :</td>*}
{*<td> {$user->stats->productsnumactiveother} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> productsnumother :</td>*}
{*<td> {$user->stats->productsnumother} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> productsnumactive :</td>*}
{*<td> {$user->stats->productsnumactive} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> productsnumtotal :</td>*}
{*<td> {$user->stats->productsnumtotal} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> numtickets :</td>*}
{*<td> {$user->stats->numtickets} </td>*}
{*</tr>*}
{*<tr>*}
{*<td> numactivetickets :</td>*}
{*<td> {$user->stats->numactivetickets} </td>*}
{*</tr>*}
        ...
        <div class="portlet light profile-sidebar-portlet bordered">
            ...
            <div class="profile-usermenu">
                <ul class="nav">
                    <li class="active">
                        <a href="#">
                            <i class="icon-home"></i> Ticket List s</a>
                    </li>
                    <li>
                        <a href="#">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="tile">
                                <div class="wrapper">
                                    <div class="header">Credit Info</div>

                                    <div class="pic-back"><strong class="text-center"
                                                                    style="display: block;color: #000000;">BALANCE</strong>
                                        <h3 class="text-center"> {$user->stats->creditbalance} </h3>
                                    </div>

                                    <div class="dates">
                                        <div class="start">
                                            <strong>UNPAID</strong> {$user->stats->numunpaidinvoices}
                                            <span></span>
                                        </div>
                                        <div class="ends">
                                            <strong>AMOUNT</strong> {$user->stats->unpaidinvoicesamount}
                                        </div>
                                    </div>
                                    ...
                                    <div class="stats">
                                        ...
                                        <div>
                                            <strong>CANCELLED INV</strong> {$user->stats->numcancelledinvoices}
                                        </div>

                                        <div>
                                            <strong>AMOUNT</strong> {$user->stats->cancelledinvoicesamount}
                                        </div>
                                    </div>
                                    ...
                                    <div class="stats">
                                        ...
                                        <div>
                                            <strong>REFUND INV</strong> {$user->stats->numrefundedinvoices}
                                        </div>

                                        <div>
                                            <strong>AMOUNT</strong> {$user->stats->refundedinvoicesamount}
                                        </div>
                                    ...
                                    <div class="footer">
                                        <a href="#" class="Cbtn Cbtn-primary btn-block text-center">Invoice</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="wrapper">
                                    ...
                                    <div class="pic-back">
                                        <strong class="text-center"
                                                style="display: block;color: #000000;">Tikcets</strong>
                                        <h3 class="text-center"> {$user->stats->numtickets} </h3>
                                    </div>

                                    <div class="dates">
                                        <div class="start">
                                            <strong>ACTIVE</strong> {$user->stats->numactivetickets}
                                            <span></span>
                                        </div>
                                        <div class="ends">
                                            <strong>CANCELLED</strong> 5
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="tile">
                            <div class="wrapper">
                                ...
                                <div class="pic-back">
                                    <strong class="text-center"
                                            style="display: block;color: #000000;">Products</strong>
                                    <h3 class="text-center"> {$user->stats->productsnumtotal} </h3>
                                </div>

                                <div class="dates">
                                    <div class="start">
                                        <strong>ACTIVE</strong> {$user->stats->productsnumactive}
                                        <span></span>
                                    </div>
                                    <div class="ends">
                                        <strong>CANCELLED</strong> 5
