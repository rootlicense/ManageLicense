            ...
            {foreach from=$Licenses item=license}
                <tr class="text-center">
                    ...
                    <td>
                        ...
                        <div class="btn-group">
                            <a href="https://licenseha.com/cp/serversalm/addonmodules.php?module=Licenses_Helper&action=removecPanel&serviceid={$license->serviceid|escape:'url'}">
                            ...
                            <a href="https://licenseha.com/cp/serversalm/addonmodules.php?module=Licenses_Helper&action=updatecPanel&serviceid={$license->serviceid|escape:'url'}">
                                <button type="button" class="btn btn-default" data-toggle="tooltip"
                                        data-placement="bottom"
                                        title=""
